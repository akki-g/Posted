...
// Extracted from the former app/news.tsx. Renders without page chrome — the
// /portfolio container owns AppShell, the page header, and the tab row. The
// old AppShell pull-to-refresh is replaced by the in-body "Refresh providers"
// button, which already triggers the same provider refresh.
...
const styles = StyleSheet.create({
  ...
  listPanel: { flex: 1, minWidth: 300, borderWidth: 1, borderColor: roles.borderHairline, backgroundColor: colors.surface },
  panelHeader: {
    minHeight: 52,
  ...
  scoreCard: { padding: 16, marginTop: 18 },
  ...
  scoreTrack: { height: 4, backgroundColor: colors.hairlineOnDark, marginTop: 12 },
