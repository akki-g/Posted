...
import { ErrorState, LevelPill, LoadingState, Panel } from '@/components/ui';
      ...
      {query.data ? (
        <View style={styles.layout}>
          ...
          <View style={styles.sidePanel}>
            <Panel variant="inverted" style={styles.scoreCard}>
...
const styles = StyleSheet.create({
  backButton: { height: 38, borderWidth: 1, borderColor: roles.borderHairline, backgroundColor: colors.surface, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 7 },
  backText: { color: colors.ink, fontSize: 11, fontWeight: '700' },
  layout: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'flex-start', gap: 16 },
  mainPanel: { flex: 2, minWidth: 300, borderWidth: 1, borderColor: roles.borderHairline, backgroundColor: colors.surface },
  sidePanel: { flex: 1, minWidth: 270, gap: 12 },
  articleHeader: { padding: 24, borderBottomWidth: 1, borderBottomColor: roles.borderHairline },
  ...
  sourceRow: { marginTop: 25, paddingTop: 15, borderTopWidth: 1, borderTopColor: roles.borderHairline, flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 9 },
  ...
  aiInsightSection: { padding: 24, backgroundColor: colors.tealSoft, borderBottomWidth: 1, borderBottomColor: roles.borderHairline },
  ...
  reasonRow: { paddingVertical: 17, borderBottomWidth: 1, borderBottomColor: roles.borderHairline, flexDirection: 'row', gap: 14 },
  ...
  scoreLabel: { color: colors.inkOnDarkMuted, fontSize: 9, fontWeight: '800', letterSpacing: 1.1 },
  score: { color: colors.white, fontSize: 58, fontWeight: '600', marginTop: 14, fontVariant: ['tabular-nums'] },
  scoreOutOf: { color: colors.inkOnDarkMuted, fontSize: 8, fontWeight: '800', letterSpacing: 0.8 },
  scoreTrack: { height: 4, backgroundColor: colors.hairlineOnDark, marginTop: 20 },
  scoreFill: { height: 4, backgroundColor: colors.teal },
  confidence: { color: colors.inkOnDarkFaint, fontSize: 10, marginTop: 12 },
  exposureCard: { borderWidth: 1, borderColor: roles.borderHairline, backgroundColor: colors.surface, paddingTop: 18 },
  securityRow: { minHeight: 68, paddingHorizontal: 18, borderTopWidth: 1, borderTopColor: roles.borderHairline, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 15 },
